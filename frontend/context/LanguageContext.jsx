...
const arTranslations = {
    ...
    'workshop.customRequests': 'الطلبات الخاصة',
    ...
    // Custom Request Form
    'custom.title': 'اطلب أثاث بمواصفات خاصة',
    'custom.subtitle': 'صف لنا ما تريد، وسنقوم بإيصال طلبك لأفضل الورش الحرفية في منطقتك لتقديم عروض أسعار.',
    'custom.type': 'نوع الأثاث',
    'custom.typeSelect': 'اختر النوع...',
    'custom.kitchen': 'مطبخ (Kitchen)',
    'custom.sofa': 'أريكة / صالون (Sofa)',
    'custom.bedroom': 'غرفة نوم (Bedroom)',
    'custom.table': 'طاولة / كراسي',
    'custom.decoration': 'ديكور خشبي',
    'custom.other': 'آخر',
    'custom.details': 'التفاصيل والمواصفات',
    'custom.detailsPlaceholder': 'اذكر الأبعاد، المواد المفضلة، الألوان، وأي تفاصيل أخرى تساعد الورشة على فهم طلبك...',
    'custom.wilaya': 'الولاية / المنطقة',
    'custom.wilayaSelect': 'اختر ولايتك...',
    'custom.budget': 'الميزانية التقديرية (د.ج)',
    'custom.budgetExample': 'اختياري (مثال: 50000)',
    'custom.upload': 'اضغط لرفع صور توضيحية',
    'custom.uploadHint': 'يمكنك اختيار صور متعددة لمساعدة الورشة على الفهم الأفضل (اختياري)',
    'custom.imagesSuccess': 'تم تحديد الصور بنجاح',
    'custom.submit': 'إرسال الطلب الآن 🚀',
    'custom.sending': 'جاري الإرسال...',
    'custom.success': 'تم إرسال طلبك بنجاح! تم إشعار ',
    'custom.successWorkshops': ' ورشة قريبة منك.',
    'custom.error': 'حدث خطأ ما',
    'custom.failObj': 'فشل الاتصال بالخادم',
    'custom.agreement': 'بإرسال الطلب، أنت توافق على مشاركة تفاصيله حصرياً مع الورشات الحرفية المعتمدة في منصتنا.',
...
const enTranslations = {
    ...
    'workshop.customRequests': 'Custom Requests',
    ...
    // Custom Request Form
    'custom.title': 'Request Custom Furniture',
    'custom.subtitle': 'Describe what you want, and we will route your request to the best workshops in your area for quotes.',
    'custom.type': 'Furniture Type',
    'custom.typeSelect': 'Select type...',
    'custom.kitchen': 'Kitchen',
    'custom.sofa': 'Sofa / Living Room',
    'custom.bedroom': 'Bedroom',
    'custom.table': 'Table / Chairs',
    'custom.decoration': 'Wooden Decoration',
    'custom.other': 'Other',
    'custom.details': 'Details & Specifications',
    'custom.detailsPlaceholder': 'Mention dimensions, preferred materials, colors, and any other details...',
    'custom.wilaya': 'State / Region',
    'custom.wilayaSelect': 'Select your state...',
    'custom.budget': 'Estimated Budget (DZD)',
    'custom.budgetExample': 'Optional (e.g., 50000)',
    'custom.upload': 'Click to upload explanatory images',
    'custom.uploadHint': 'You can select multiple images to help workshops understand better (Optional)',
    'custom.imagesSuccess': 'Images selected successfully',
    'custom.submit': 'Send Request Now 🚀',
    'custom.sending': 'Sending...',
    'custom.success': 'Request sent successfully! Notified ',
    'custom.successWorkshops': ' nearby workshops.',
    'custom.error': 'An error occurred',
    'custom.failObj': 'Failed to connect to server',
    'custom.agreement': 'By submitting, you agree to share the details exclusively with verified workshop artisans on our platform.',
